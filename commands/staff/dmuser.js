...
module.exports = {
  data: new SlashCommandBuilder()
    .setName('dm')
    .setDescription('Sends a DM message to a selected user in the form of an embed')
  ...
  run: async (client, interaction) => {
    ...
    try {
      ...
      await interaction.reply({
        content: 'An error occurred while sending the DM. The user may have DMs disabled or may not be reachable.',
        ephemeral: true,
      });
    }
  },
