...
module.exports = {
  data: new SlashCommandBuilder()
    .setName("help")
    .setDescription(
      "Displays a list of available commands with the Plinxy bot :D"
    ),
  run: async (client, interaction) => {
    const commands = [
      ...
      {
        name: "say",
        description: "Makes the bot say the message you provide.",
      },
      {
        name: "steal",
        description:
          "Steal an emoji from another server using its emoji ID or URL and add it to this server.",
      },
      {
        name: "random",
      ...
      { name: "embedbuilder", description: "Create a custom embed." },
      {
        name: "currenttime",
        description:
          "Displays the current date and time in the specified timezone.",
      },
    ];
